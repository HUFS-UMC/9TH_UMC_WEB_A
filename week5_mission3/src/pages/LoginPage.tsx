      ...
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          className={`w-full py-3 rounded-md text-lg font-medium text-white
            ${isDisabled ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700 transition-colors"}`}
        >
          로그인
        </button>
        <button
          ...
          className={`w-full py-3 rounded-md text-lg font-medium text-white bg-blue-600 hover:bg-blue-700 transition-colors`}>
