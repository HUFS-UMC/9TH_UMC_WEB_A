  ...
  return (
    <div className="flex items-center p-4 border-b border-gray-200">
      ...
      <div className="flex-1">
        ...
        <p className="text-lg font-bold mt-2">${lp.price} 원</p>
      </div>
      <div className="flex items-center">
        <button
          onClick={handleDecreaseCount}
          className="px-3 py-1 bg-gray-300 text-600 text-gray-800 rounded-l hover:bg-gray-400 cursor-pointer"
        >
          -
        </button>
        ...
        <button
          ...
          className="px-3 py-1 bg-gray-300 text-600 text-gray-800 rounded-r hover:bg-gray-400 cursor-pointer"
        >
          +
        </button>
      </div>
